...
OUT = "figs_14_aug/figG_compliance.png"
...
axL.set_xticklabels([str(d) for d in budgets])
axL.set_xlim(-0.6, len(budgets) - 0.4)
axL.set_xlabel("safety budget d (newton steps)")
axL.set_ylabel("actual episode cost (newton steps)")
...
axR.set_title("Weighted penalty (R4) [5]", fontsize=18, pad=10)
