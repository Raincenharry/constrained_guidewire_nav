...
Train pool  -> ArchType I, II, IV, V   (in distribution)
Test pool   -> ArchType VI, VII        (out of distribution, held out)
...
def build_figure():
    ...
    sub_train.suptitle("Training pool", fontsize=FONT_GROUP, fontweight="bold",
                       y=0.98)
    sub_train.text(0.5, 0.905, "in distribution, seen during training",
    ...
    sub_test.text(0.5, 0.905, "out of distribution, never seen during training",
